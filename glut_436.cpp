...
void
engine_glut_436_reshape (int width_in, int height_in)
{
...
void
engine_glut_436_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_436_CBData*> (glutGetWindowData ());
...
void
engine_glut_436_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
...
void
engine_glut_436_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_436_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_436_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_436_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_436_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_436_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_436_timer (int v)
{
  ...
  glutTimerFunc (1000 / 30,
                 engine_glut_436_timer,
                 v);
}

void
engine_glut_436_draw (void)
{
  struct Engine_OpenGL_GLUT_436_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_436_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
#error missing implementation, aborting
  ...
  glProgramUniform1f (cb_data_p->shader.id_, cb_data_p->speedLoc,
  ...
  glTranslatef (static_cast<GLfloat> (-ENGINE_GLUT_436_DEFAULT_WIDTH / 2.0f),
                static_cast<GLfloat> (-ENGINE_GLUT_436_DEFAULT_HEIGHT / 2.0f),
                0.0f);
...
void
engine_glut_436_idle (void)
{
  glutPostRedisplay ();
}

void
engine_glut_436_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_436_idle);
  else
    glutIdleFunc (NULL);
}
