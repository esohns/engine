...
void
engine_glut_891_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_891_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_891_CBData*> (glutGetWindowData ());
...
void
engine_glut_891_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
...
void
engine_glut_891_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
...
void
engine_glut_891_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
...
void
engine_glut_891_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_891_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_891_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_891_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_891_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_891_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_891_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_891_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_891_timer,
                 v);
}

void
engine_glut_891_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_891_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_891_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader2.id_, cb_data_p->S2mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_891_DEFAULT_HEIGHT - 1, ENGINE_GLUT_891_DEFAULT_HEIGHT - 1, 0)),
  ...
  glProgramUniform1i (cb_data_p->shader3.id_, cb_data_p->S3channel2Loc,
                      static_cast<GLint> (1));
  glProgramUniform1i (cb_data_p->shader3.id_, cb_data_p->S3channel3Loc,
                      static_cast<GLint> (5));
...
void
engine_glut_891_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_891_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_891_idle);
  else
    glutIdleFunc (NULL);
}
