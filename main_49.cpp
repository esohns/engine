         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    {
      struct Engine_OpenGL_GLUT_1010_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1010_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1010_DEFAULT_HEIGHT / 2;
      ...
      glutInitWindowSize (ENGINE_GLUT_1010_DEFAULT_WIDTH, ENGINE_GLUT_1010_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1010");
      ...
      glutDisplayFunc (engine_glut_1010_draw);
      glutReshapeFunc (engine_glut_1010_reshape);
      glutVisibilityFunc (engine_glut_1010_visible);

      glutKeyboardFunc (engine_glut_1010_key);
      glutKeyboardUpFunc (engine_glut_1010_key_up);
      glutSpecialFunc (engine_glut_1010_key_special);
      glutSpecialUpFunc (engine_glut_1010_key_special_up);

      glutMouseFunc (engine_glut_1010_mouse_button);
      glutMotionFunc (engine_glut_1010_mouse_move);
      glutPassiveMotionFunc (engine_glut_1010_mouse_move);

      glutTimerFunc (100, engine_glut_1010_timer, 0);

      glutCreateMenu (engine_glut_1010_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1010.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_1010.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1010.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_1010.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_1010_DEFAULT_WIDTH * ENGINE_GLUT_1010_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_1010_DEFAULT_WIDTH, ENGINE_GLUT_1010_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      ...
      if (!cb_data_s.texture1.load (ACE_TEXT_ALWAYS_CHAR ("glut_964_S1channel0.jpg"), false)) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture2.load (ACE_TEXT_ALWAYS_CHAR ("glut_964_S2channel1.png"), false)) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture3.load (ACE_TEXT_ALWAYS_CHAR ("glut_873_channel1.jpg"), false)) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1011:
    {
      struct Engine_OpenGL_GLUT_1011_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1011_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1011_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1011_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1011_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1011_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1011_DEFAULT_WIDTH, ENGINE_GLUT_1011_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1011");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1011_draw);
      glutReshapeFunc (engine_glut_1011_reshape);
      glutVisibilityFunc (engine_glut_1011_visible);

      glutKeyboardFunc (engine_glut_1011_key);
      glutKeyboardUpFunc (engine_glut_1011_key_up);
      glutSpecialFunc (engine_glut_1011_key_special);
      glutMouseFunc (engine_glut_1011_mouse_button);
      glutMotionFunc (engine_glut_1011_mouse_move);
      glutPassiveMotionFunc (engine_glut_1011_mouse_move);

      glutTimerFunc (100, engine_glut_1011_timer, 0);

      glutCreateMenu (engine_glut_1011_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_964_S2channel1.png"), false)) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1011.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1011.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
