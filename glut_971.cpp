...
void
engine_glut_971_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_971_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_971_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
      ...
      break;
    case 'w':
      cb_data_p->isWKeyPressed = true;
      break;
    case 'a':
      cb_data_p->isAKeyPressed = true;
      break;
    case 's':
      cb_data_p->isSKeyPressed = true;
      break;
    case 'd':
...
void
engine_glut_971_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
  ...
  {
    case 'w':
      cb_data_p->isWKeyPressed = false;
      break;
    case 'a':
      cb_data_p->isAKeyPressed = false;
      break;
    case 's':
      cb_data_p->isSKeyPressed = false;
      break;
    case 'd':
...
void
engine_glut_971_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
...
void
engine_glut_971_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
...
void
engine_glut_971_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_971_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_971_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_971_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  switch (button)
  {
    case GLUT_LEFT_BUTTON:
    {
      ...
      {
        cb_data_p->lastLMBPressedX = x;
        cb_data_p->lastLMBPressedY = y;
      }
      break;
    }
    default:
...
void
engine_glut_971_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_971_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_971_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_971_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_971_timer,
                 v);
}

void
engine_glut_971_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_971_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_971_DEFAULT_HEIGHT));
...
#error missing implementation, aborting
  ...
  glProgramUniform4i (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      static_cast<GLint> (cb_data_p->isWKeyPressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->isAKeyPressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->isSKeyPressed ? 1 : 0),
  ...
  glProgramUniform4f (cb_data_p->shader1.id_, cb_data_p->S1mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_971_DEFAULT_HEIGHT - 1, ENGINE_GLUT_971_DEFAULT_HEIGHT - 1, 0)),
                      static_cast<GLfloat> (cb_data_p->mouseLMBPressed ? cb_data_p->lastLMBPressedX : 0),
                      static_cast<GLfloat> (cb_data_p->mouseLMBPressed ? Common_GL_Tools::map (cb_data_p->lastLMBPressedY, 0, ENGINE_GLUT_971_DEFAULT_HEIGHT - 1, ENGINE_GLUT_971_DEFAULT_HEIGHT - 1, 0) : 0));
...
void
engine_glut_971_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_971_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_971_idle);
  else
    glutIdleFunc (NULL);
}
