...
void
engine_glut_894_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_894_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_894_CBData*> (glutGetWindowData ());
...
void
engine_glut_894_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
...
void
engine_glut_894_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
...
void
engine_glut_894_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
...
void
engine_glut_894_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_894_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_894_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_894_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_894_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_894_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_894_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_894_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_894_timer,
                 v);
}

void
engine_glut_894_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader.id_, cb_data_p->resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_894_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_894_DEFAULT_HEIGHT));

  glProgramUniform1f (cb_data_p->shader.id_, cb_data_p->timeLoc,
                      static_cast<GLfloat> (d.count () * 0.001f));

  glProgramUniform1f (cb_data_p->shader.id_, cb_data_p->channel0Loc,
                      static_cast<GLint> (0));
...
void
engine_glut_894_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_894_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_894_idle);
  else
    glutIdleFunc (NULL);
}
