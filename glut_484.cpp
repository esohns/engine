...
void
engine_glut_484_reshape (int width_in, int height_in)
{
...
void
engine_glut_484_key (unsigned char key_in,
                     int x,
                     int y)
{
...
void
engine_glut_484_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
...
void
engine_glut_484_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
...
void
engine_glut_484_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
...
void
engine_glut_484_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_484_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_484_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_484_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_484_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_484_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_484_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_484_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_484_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_484_idle);
  else
    glutIdleFunc (NULL);
}
