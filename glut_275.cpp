...
void
engine_glut_275_reshape (int width_in, int height_in)
{
...
void
engine_glut_275_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_275_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_275_CBData*> (glutGetWindowData ());
...
void
engine_glut_275_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_275_CBData* cb_data_p =
...
void
engine_glut_275_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_275_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_275_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_275_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_275_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_275_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_275_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_275_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_275_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_275_timer (int v)
{
  ...
  //  glutPostRedisplay();
  //} // end IF
  glutTimerFunc (1000 / 30, engine_glut_275_timer, v);
}

void
engine_glut_275_draw (void)
{
  ...
  //pointLight(255, 255, 255, 1000, 0, 2000);
  //ambientLight(60, 60, 60);
  //static GLfloat light_position_a[] = {1000.0f, 0.0f, 2000.0f};
  static GLfloat light_position_2[] = {0.0f, 250.0f, 500.0f};
  ...
  static GLint light_ambient_2[] = { 255, 255, 255, 255 };
  static GLint light_diffuse_2[] = { 255, 255, 255, 255 };
  static GLint light_specular_2 [] = { 255, 255, 255, 255 };
  ...
  //ambientMaterial(250, 150, 155);
  static GLint material_color_a[] = {250, 150, 155, 255};
  ...
  glMaterialiv (GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, material_color_a);
  ...
  for (std::vector<cell>::iterator iterator = cb_data_p->cells.begin ();
       iterator != cb_data_p->cells.end ();
       ++iterator)
  {
    (*iterator).update (cb_data_p->noise,
                        frame_count_i);
    (*iterator).display ();
  } // end FOR
...
void
engine_glut_275_idle (void)
{
  glutPostRedisplay ();
}

void
engine_glut_275_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_275_idle);
  else
    glutIdleFunc (NULL);
}
