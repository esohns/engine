...
void
intersectSphere (Sphere sphere, Ray ray, Material material, inout Output o)
{
...
void
intersectPlane (Plane plane, Ray ray, Material material, inout Output o)
{
...
vec3
illuminatePointLight (PointLight light, Output o)
{
...
Ray
getPrimaryRay (vec3 origin, vec3 lookat, vec2 fragCoord)
{
