...
const vec2 part_max_mov = vec2(0.16, 0.16);

const float time_factor = 1.0;
const float start_time = 2.5;
const float grow_time_factor = 0.15;
#if complexity == 1
const float part_life_time_min = 0.8;
const float part_life_time_max = 1.6;
#elif complexity == 2
...
//#define motion_blur
const float mb_time = 0.02;
const int mb_nb_samples = 2;
