...
void
engine_glut_746_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_746_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_746_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
      ...
      break;
    case 100: /* d */
      cb_data_p->DKeyPressed = true;
      break;
    case 102: /* f */
      cb_data_p->FKeyPressed = true;
      break;
    case 115: /* s */
      cb_data_p->SKeyPressed = true;
      break;
    default:
      break;
  } // end SWITCH
...
void
engine_glut_746_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
...
void
engine_glut_746_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
...
void
engine_glut_746_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
...
void
engine_glut_746_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_746_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_746_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_746_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_746_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_746_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_746_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_746_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_746_timer,
                 v);
}

void
engine_glut_746_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_746_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_746_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader1.id_, cb_data_p->S1mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_746_DEFAULT_HEIGHT - 1, ENGINE_GLUT_746_DEFAULT_HEIGHT - 1, 0)),
  ...
  glProgramUniform4i (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      ...
                      static_cast<GLint> (cb_data_p->DKeyPressed ? 1 : 0),
  ...
  glProgramUniform4i (cb_data_p->shader2.id_, cb_data_p->S2keysLoc,
                      static_cast<GLint> (cb_data_p->SKeyPressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->DKeyPressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->FKeyPressed ? 1 : 0),
                      static_cast<GLint> (0));
...
void
engine_glut_746_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_746_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_746_idle);
  else
    glutIdleFunc (NULL);
}
