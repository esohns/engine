...
void
engine_glut_743_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_743_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_743_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
      ...
      break;
    case 32: /* Space */
      cb_data_p->spaceKeyPressed = true;
      break;
    default:
      break;
  } // end SWITCH
...
void
engine_glut_743_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
  ...
  {
    case 32: /* Space */
      cb_data_p->spaceKeyPressed = false;
      break;
    default:
      break;
  } // end SWITCH
...
void
engine_glut_743_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
...
void
engine_glut_743_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
...
void
engine_glut_743_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_743_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_743_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_743_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_743_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_743_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_743_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_743_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_743_timer,
                 v);
}

void
engine_glut_743_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_743_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_743_DEFAULT_HEIGHT));
  ...
  glProgramUniform4i (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      static_cast<GLint> (cb_data_p->spaceKeyPressed ? 1 : 0),
                      static_cast<GLint> (0),
                      static_cast<GLint> (0),
                      static_cast<GLint> (0));
  ...
  glProgramUniform4f (cb_data_p->shader2.id_, cb_data_p->S2mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_743_DEFAULT_HEIGHT - 1, ENGINE_GLUT_743_DEFAULT_HEIGHT - 1, 0)),
...
void
engine_glut_743_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_743_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_743_idle);
  else
    glutIdleFunc (NULL);
}
