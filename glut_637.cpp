...
void
engine_glut_637_reshape (int width_in, int height_in)
{
...
void
engine_glut_637_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_637_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
      ...
      break;
    case 32: /* Space */
      cb_data_p->isSpacePressed = true;
      break;
    case 101: /* E */
      cb_data_p->isEPressed = true;
      break;
    case 115: /* S */
      cb_data_p->isSPressed = true;
      break;
  } // end SWITCH
}

void
engine_glut_637_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
  ...
  {
    case 32: /* Space */
      cb_data_p->isSpacePressed = false;
      break;
    case 101: /* E */
      cb_data_p->isEPressed = false;
      break;
    case 115: /* S */
      cb_data_p->isSPressed = false;
      break;
  } // end SWITCH
}

void
engine_glut_637_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
...
void
engine_glut_637_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
...
void
engine_glut_637_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_637_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_637_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_637_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_637_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_637_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_637_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_637_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_637_timer,
                 v);
}

void
engine_glut_637_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_637_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_637_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader1.id_, cb_data_p->S1mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_637_DEFAULT_HEIGHT - 1, ENGINE_GLUT_637_DEFAULT_HEIGHT - 1, 0)),
                      static_cast<GLfloat> (cb_data_p->mouseLMBPressed ? 1 : 0),
                      static_cast<GLfloat> (0));

  glProgramUniform2i (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      static_cast<GLint> (cb_data_p->isEPressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->isSPressed ? 1 : 0));
  ...
  glProgramUniform4f (cb_data_p->shader5.id_, cb_data_p->S5mouseLoc,
                      static_cast<GLfloat> (cb_data_p->mouseX),
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_637_DEFAULT_HEIGHT - 1, ENGINE_GLUT_637_DEFAULT_HEIGHT - 1, 0)),
                      static_cast<GLfloat> (cb_data_p->mouseLMBPressed ? 1 : 0),
                      static_cast<GLfloat> (0));

  glProgramUniform2i (cb_data_p->shader5.id_, cb_data_p->S5keysLoc,
                      static_cast<GLint> (cb_data_p->isSpacePressed ? 1 : 0),
                      static_cast<GLint> (cb_data_p->isCtrlPressed ? 1 : 0));
...
void
engine_glut_637_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_637_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_637_idle);
  else
    glutIdleFunc (NULL);
}
