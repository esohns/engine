...
void
engine_glut_667_reshape (int width_in, int height_in)
{
...
void
engine_glut_667_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_667_CBData*> (glutGetWindowData ());
...
void
engine_glut_667_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
...
void
engine_glut_667_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
...
void
engine_glut_667_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
...
void
engine_glut_667_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_667_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_667_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_667_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_667_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_667_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_667_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_667_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_667_timer,
                 v);
}

void
engine_glut_667_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform4i (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      ...
                      static_cast<GLint> (cb_data_p->isCtrlKeyPressed  ? 1 : 0),
                      0, // *TODO*: implement more keys (see glut_667.frag)
                      0);
  ...
  glProgramUniform2f (cb_data_p->shader2.id_, cb_data_p->S2resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_667_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_667_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader2.id_, cb_data_p->S2mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_667_DEFAULT_HEIGHT - 1, ENGINE_GLUT_667_DEFAULT_HEIGHT - 1, 0)),
...
void
engine_glut_667_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_667_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_667_idle);
  else
    glutIdleFunc (NULL);
}
