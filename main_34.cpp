         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_727:
    {
      struct Engine_OpenGL_GLUT_727_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_727_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_727_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_727_DEFAULT_WIDTH, ENGINE_GLUT_727_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 727");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_727_draw);
      glutReshapeFunc (engine_glut_727_reshape);
      glutVisibilityFunc (engine_glut_727_visible);

      glutKeyboardFunc (engine_glut_727_key);
      glutKeyboardUpFunc (engine_glut_727_key_up);
      glutSpecialFunc (engine_glut_727_key_special);
      glutSpecialUpFunc (engine_glut_727_key_special_up);

      glutMouseFunc (engine_glut_727_mouse_button);
      glutMotionFunc (engine_glut_727_mouse_move);
      glutPassiveMotionFunc (engine_glut_727_mouse_move);

      glutTimerFunc (100, engine_glut_727_timer, 0);

      glutCreateMenu (engine_glut_727_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_727.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_727.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_727.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_727.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_727.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_727.frag_3")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader4.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_727.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_727.frag_4")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_727_DEFAULT_WIDTH * ENGINE_GLUT_727_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_727_DEFAULT_WIDTH, ENGINE_GLUT_727_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
      //glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_728:
    {
      struct Engine_OpenGL_GLUT_728_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_728_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_728_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_728_DEFAULT_WIDTH, ENGINE_GLUT_728_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 728");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_728_draw);
      glutReshapeFunc (engine_glut_728_reshape);
      glutVisibilityFunc (engine_glut_728_visible);

      glutKeyboardFunc (engine_glut_728_key);
      glutKeyboardUpFunc (engine_glut_728_key_up);
      glutSpecialFunc (engine_glut_728_key_special);
      glutSpecialUpFunc (engine_glut_728_key_special_up);

      glutMouseFunc (engine_glut_728_mouse_button);
      glutMotionFunc (engine_glut_728_mouse_move);
      glutPassiveMotionFunc (engine_glut_728_mouse_move);

      glutTimerFunc (100, engine_glut_728_timer, 0);

      glutCreateMenu (engine_glut_728_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_728.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_728.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_728.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_728.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_728_DEFAULT_WIDTH * ENGINE_GLUT_728_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_728_DEFAULT_WIDTH, ENGINE_GLUT_728_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
      //glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_729:
    {
      struct Engine_OpenGL_GLUT_729_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_729_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_729_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_729_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_729_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_729_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_729_DEFAULT_WIDTH, ENGINE_GLUT_729_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 729");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_729_draw);
      glutReshapeFunc (engine_glut_729_reshape);
      glutVisibilityFunc (engine_glut_729_visible);

      glutKeyboardFunc (engine_glut_729_key);
      glutKeyboardUpFunc (engine_glut_729_key_up);
      glutSpecialFunc (engine_glut_729_key_special);
      glutMouseFunc (engine_glut_729_mouse_button);
      glutMotionFunc (engine_glut_729_mouse_move);
      glutPassiveMotionFunc (engine_glut_729_mouse_move);

      glutTimerFunc (100, engine_glut_729_timer, 0);

      glutCreateMenu (engine_glut_729_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_729.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_729.frag")))
      {
         ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
         break;
