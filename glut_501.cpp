...
void
engine_glut_501_reshape (int width_in, int height_in)
{
...
void
engine_glut_501_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_501_CBData*> (glutGetWindowData ());
...
void
engine_glut_501_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
...
void
engine_glut_501_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
...
void
engine_glut_501_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
...
void
engine_glut_501_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_501_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_501_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_501_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_501_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_501_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_501_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_501_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_501_timer,
                 v);
}

void
engine_glut_501_draw (void)
{
...
void
engine_glut_501_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_501_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_501_idle);
  else
    glutIdleFunc (NULL);
}
