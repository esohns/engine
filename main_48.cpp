         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_1002:
    {
      struct Engine_OpenGL_GLUT_1002_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1002_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1002_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1002_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1002_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1002_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1002_DEFAULT_WIDTH, ENGINE_GLUT_1002_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1002");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1002_draw);
      glutReshapeFunc (engine_glut_1002_reshape);
      glutVisibilityFunc (engine_glut_1002_visible);

      glutKeyboardFunc (engine_glut_1002_key);
      glutKeyboardUpFunc (engine_glut_1002_key_up);
      glutSpecialFunc (engine_glut_1002_key_special);
      glutMouseFunc (engine_glut_1002_mouse_button);
      glutMotionFunc (engine_glut_1002_mouse_move);
      glutPassiveMotionFunc (engine_glut_1002_mouse_move);

      glutTimerFunc (100, engine_glut_1002_timer, 0);

      glutCreateMenu (engine_glut_1002_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1002.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1002.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1003:
    {
      struct Engine_OpenGL_GLUT_1003_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1003_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1003_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1003_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1003_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1003_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1003_DEFAULT_WIDTH, ENGINE_GLUT_1003_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1003");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1003_draw);
      glutReshapeFunc (engine_glut_1003_reshape);
      glutVisibilityFunc (engine_glut_1003_visible);

      glutKeyboardFunc (engine_glut_1003_key);
      glutKeyboardUpFunc (engine_glut_1003_key_up);
      glutSpecialFunc (engine_glut_1003_key_special);
      glutMouseFunc (engine_glut_1003_mouse_button);
      glutMotionFunc (engine_glut_1003_mouse_move);
      glutPassiveMotionFunc (engine_glut_1003_mouse_move);

      glutTimerFunc (100, engine_glut_1003_timer, 0);

      glutCreateMenu (engine_glut_1003_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1003.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1003.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1004:
    {
      struct Engine_OpenGL_GLUT_1004_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1004_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1004_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1004_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1004_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1004_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1004_DEFAULT_WIDTH, ENGINE_GLUT_1004_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1004");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1004_draw);
      glutReshapeFunc (engine_glut_1004_reshape);
      glutVisibilityFunc (engine_glut_1004_visible);

      glutKeyboardFunc (engine_glut_1004_key);
      glutKeyboardUpFunc (engine_glut_1004_key_up);
      glutSpecialFunc (engine_glut_1004_key_special);
      glutMouseFunc (engine_glut_1004_mouse_button);
      glutMotionFunc (engine_glut_1004_mouse_move);
      glutPassiveMotionFunc (engine_glut_1004_mouse_move);

      glutTimerFunc (100, engine_glut_1004_timer, 0);

      glutCreateMenu (engine_glut_1004_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1004.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1004.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1005:
    {
      struct Engine_OpenGL_GLUT_1005_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1005_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1005_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1005_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1005_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1005_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1005_DEFAULT_WIDTH, ENGINE_GLUT_1005_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1005");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1005_draw);
      glutReshapeFunc (engine_glut_1005_reshape);
      glutVisibilityFunc (engine_glut_1005_visible);

      glutKeyboardFunc (engine_glut_1005_key);
      glutKeyboardUpFunc (engine_glut_1005_key_up);
      glutSpecialFunc (engine_glut_1005_key_special);
      glutMouseFunc (engine_glut_1005_mouse_button);
      glutMotionFunc (engine_glut_1005_mouse_move);
      glutPassiveMotionFunc (engine_glut_1005_mouse_move);

      glutTimerFunc (100, engine_glut_1005_timer, 0);

      glutCreateMenu (engine_glut_1005_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1005.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1005.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1006:
    {
      struct Engine_OpenGL_GLUT_1006_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1006_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1006_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1006_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1006_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1006_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1006_DEFAULT_WIDTH, ENGINE_GLUT_1006_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1006");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1006_draw);
      glutReshapeFunc (engine_glut_1006_reshape);
      glutVisibilityFunc (engine_glut_1006_visible);

      glutKeyboardFunc (engine_glut_1006_key);
      glutKeyboardUpFunc (engine_glut_1006_key_up);
      glutSpecialFunc (engine_glut_1006_key_special);
      glutMouseFunc (engine_glut_1006_mouse_button);
      glutMotionFunc (engine_glut_1006_mouse_move);
      glutPassiveMotionFunc (engine_glut_1006_mouse_move);

      glutTimerFunc (100, engine_glut_1006_timer, 0);

      glutCreateMenu (engine_glut_1006_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1006.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1006.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_575_channel1.png"))) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1007:
    {
      struct Engine_OpenGL_GLUT_1007_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1007_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1007_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1007_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1007_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1007_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1007_DEFAULT_WIDTH, ENGINE_GLUT_1007_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1007");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1007_draw);
      glutReshapeFunc (engine_glut_1007_reshape);
      glutVisibilityFunc (engine_glut_1007_visible);

      glutKeyboardFunc (engine_glut_1007_key);
      glutKeyboardUpFunc (engine_glut_1007_key_up);
      glutSpecialFunc (engine_glut_1007_key_special);
      glutMouseFunc (engine_glut_1007_mouse_button);
      glutMotionFunc (engine_glut_1007_mouse_move);
      glutPassiveMotionFunc (engine_glut_1007_mouse_move);

      glutTimerFunc (100, engine_glut_1007_timer, 0);

      glutCreateMenu (engine_glut_1007_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1007.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1007.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1008:
    {
      struct Engine_OpenGL_GLUT_1008_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1008_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1008_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1008_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1008_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1008_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1008_DEFAULT_WIDTH, ENGINE_GLUT_1008_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1008");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1008_draw);
      glutReshapeFunc (engine_glut_1008_reshape);
      glutVisibilityFunc (engine_glut_1008_visible);

      glutKeyboardFunc (engine_glut_1008_key);
      glutKeyboardUpFunc (engine_glut_1008_key_up);
      glutSpecialFunc (engine_glut_1008_key_special);
      glutMouseFunc (engine_glut_1008_mouse_button);
      glutMotionFunc (engine_glut_1008_mouse_move);
      glutPassiveMotionFunc (engine_glut_1008_mouse_move);

      glutTimerFunc (100, engine_glut_1008_timer, 0);

      glutCreateMenu (engine_glut_1008_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1008.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1008.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_1009:
    {
      struct Engine_OpenGL_GLUT_1009_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_1009_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_1009_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_1009_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_1009_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_1009_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_1009_DEFAULT_WIDTH, ENGINE_GLUT_1009_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 1009");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_1009_draw);
      glutReshapeFunc (engine_glut_1009_reshape);
      glutVisibilityFunc (engine_glut_1009_visible);

      glutKeyboardFunc (engine_glut_1009_key);
      glutKeyboardUpFunc (engine_glut_1009_key_up);
      glutSpecialFunc (engine_glut_1009_key_special);
      glutMouseFunc (engine_glut_1009_mouse_button);
      glutMotionFunc (engine_glut_1009_mouse_move);
      glutPassiveMotionFunc (engine_glut_1009_mouse_move);

      glutTimerFunc (100, engine_glut_1009_timer, 0);

      glutCreateMenu (engine_glut_1009_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_1009.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_1009.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
