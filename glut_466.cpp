...
void
engine_glut_466_reshape (int width_in, int height_in)
{
...
void
engine_glut_466_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_466_CBData*> (glutGetWindowData ());
...
void
engine_glut_466_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
...
void
engine_glut_466_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_466_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_466_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_466_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_466_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_466_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_466_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_466_timer,
                 v);
}

void
engine_glut_466_draw (void)
{
  struct Engine_OpenGL_GLUT_466_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_466_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_466_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_466_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_466_idle);
  else
    glutIdleFunc (NULL);
}
