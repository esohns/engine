...
float
fbm4 (vec3 p, float theta, float f, float lac, float r)
{
  mat3 mtx = mat3(
...
float
fbm8 (vec3 p, float theta, float f, float lac, float r)
{
  mat3 mtx = mat3(
        cos(theta), -sin(theta), 0.0,
        sin(theta), cos(theta), 0.0,
...
float
pattern (vec3 p, inout vec3 q, inout vec3 r)
{
