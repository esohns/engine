         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_927:
    {
      struct Engine_OpenGL_GLUT_927_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_927_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_927_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_927_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_927_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_927_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_927_DEFAULT_WIDTH, ENGINE_GLUT_927_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 927");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_927_draw);
      glutReshapeFunc (engine_glut_927_reshape);
      glutVisibilityFunc (engine_glut_927_visible);

      glutKeyboardFunc (engine_glut_927_key);
      glutKeyboardUpFunc (engine_glut_927_key_up);
      glutSpecialFunc (engine_glut_927_key_special);
      glutMouseFunc (engine_glut_927_mouse_button);
      glutMotionFunc (engine_glut_927_mouse_move);
      glutPassiveMotionFunc (engine_glut_927_mouse_move);

      glutTimerFunc (100, engine_glut_927_timer, 0);

      glutCreateMenu (engine_glut_927_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_927.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_927.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_928:
    {
      struct Engine_OpenGL_GLUT_928_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_928_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_928_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_928_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_928_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_928_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_928_DEFAULT_WIDTH, ENGINE_GLUT_928_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 928");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_928_draw);
      glutReshapeFunc (engine_glut_928_reshape);
      glutVisibilityFunc (engine_glut_928_visible);

      glutKeyboardFunc (engine_glut_928_key);
      glutKeyboardUpFunc (engine_glut_928_key_up);
      glutSpecialFunc (engine_glut_928_key_special);
      glutMouseFunc (engine_glut_928_mouse_button);
      glutMotionFunc (engine_glut_928_mouse_move);
      glutPassiveMotionFunc (engine_glut_928_mouse_move);

      glutTimerFunc (100, engine_glut_928_timer, 0);

      glutCreateMenu (engine_glut_928_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_928.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_928.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_929:
    {
      struct Engine_OpenGL_GLUT_929_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_929_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_929_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_929_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_929_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_929_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_929_DEFAULT_WIDTH, ENGINE_GLUT_929_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 929");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_929_draw);
      glutReshapeFunc (engine_glut_929_reshape);
      glutVisibilityFunc (engine_glut_929_visible);

      glutKeyboardFunc (engine_glut_929_key);
      glutKeyboardUpFunc (engine_glut_929_key_up);
      glutSpecialFunc (engine_glut_929_key_special);
      glutMouseFunc (engine_glut_929_mouse_button);
      glutMotionFunc (engine_glut_929_mouse_move);
      glutPassiveMotionFunc (engine_glut_929_mouse_move);

      glutTimerFunc (100, engine_glut_929_timer, 0);

      glutCreateMenu (engine_glut_929_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_929_channel0.jpg")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture1.load (ACE_TEXT_ALWAYS_CHAR ("glut_885_channel0.png"))) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_929.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_929.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
