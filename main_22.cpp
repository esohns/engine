         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_485:
    {
      struct Engine_OpenGL_GLUT_485_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_485_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_485_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_485_DEFAULT_WIDTH, ENGINE_GLUT_485_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 485");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_485_draw);
      glutReshapeFunc (engine_glut_485_reshape);
      glutVisibilityFunc (engine_glut_485_visible);

      glutKeyboardFunc (engine_glut_485_key);
      glutKeyboardUpFunc (engine_glut_485_key_up);
      glutSpecialFunc (engine_glut_485_key_special);
      glutSpecialUpFunc (engine_glut_485_key_special_up);
      glutMouseFunc (engine_glut_485_mouse_button);
      glutMotionFunc (engine_glut_485_mouse_move);
      glutPassiveMotionFunc (engine_glut_485_mouse_move);
      glutTimerFunc (100, engine_glut_485_timer, 0);

      glutCreateMenu (engine_glut_485_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_485.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_485.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_485.vert_2"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_485.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_485.vert_3"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_485.frag_3")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader4.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_485.vert_4"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_485.frag_4")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_485_DEFAULT_WIDTH * ENGINE_GLUT_485_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_485_DEFAULT_WIDTH, ENGINE_GLUT_485_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
      glGenerateMipmap (GL_TEXTURE_2D);
      //cb_data_s.textureS1.unbind ();
    ...
    case ENGINE_MODE_486:
    {
      struct Engine_OpenGL_GLUT_486_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_486_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_486_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_486_DEFAULT_WIDTH, ENGINE_GLUT_486_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 486");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_486_draw);
      glutReshapeFunc (engine_glut_486_reshape);
      glutVisibilityFunc (engine_glut_486_visible);

      glutKeyboardFunc (engine_glut_486_key);
      glutKeyboardUpFunc (engine_glut_486_key_up);
      glutSpecialFunc (engine_glut_486_key_special);
      glutSpecialUpFunc (engine_glut_486_key_special_up);
      glutMouseFunc (engine_glut_486_mouse_button);
      glutMotionFunc (engine_glut_486_mouse_move);
      glutPassiveMotionFunc (engine_glut_486_mouse_move);
      glutTimerFunc (100, engine_glut_486_timer, 0);

      glutCreateMenu (engine_glut_486_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_486.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_486.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_486.vert_2"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_486.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_486_DEFAULT_WIDTH * ENGINE_GLUT_486_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_486_DEFAULT_WIDTH, ENGINE_GLUT_486_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
      glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_487:
    {
      struct Engine_OpenGL_GLUT_487_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_487_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_487_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_487_DEFAULT_WIDTH, ENGINE_GLUT_487_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 487");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_487_draw);
      glutReshapeFunc (engine_glut_487_reshape);
      glutVisibilityFunc (engine_glut_487_visible);

      glutKeyboardFunc (engine_glut_487_key);
      glutKeyboardUpFunc (engine_glut_487_key_up);
      glutSpecialFunc (engine_glut_487_key_special);
      glutSpecialUpFunc (engine_glut_487_key_special_up);
      glutMouseFunc (engine_glut_487_mouse_button);
      glutMotionFunc (engine_glut_487_mouse_move);
      glutPassiveMotionFunc (engine_glut_487_mouse_move);
      glutTimerFunc (100, engine_glut_487_timer, 0);

      glutCreateMenu (engine_glut_487_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_487.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_487.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_487.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_487.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_487.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_487.frag_3")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader4.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_487.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_487.frag_4")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
      std::string neg_z_path_string = ACE_TEXT_ALWAYS_CHAR ("");
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_487_texture0.png")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_487_DEFAULT_WIDTH * ENGINE_GLUT_487_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_487_DEFAULT_WIDTH, ENGINE_GLUT_487_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
      glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_488:
    {
      struct Engine_OpenGL_GLUT_488_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_488_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_488_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_488_DEFAULT_WIDTH, ENGINE_GLUT_488_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 488");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_488_draw);
      glutReshapeFunc (engine_glut_488_reshape);
      glutVisibilityFunc (engine_glut_488_visible);

      glutKeyboardFunc (engine_glut_488_key);
      glutKeyboardUpFunc (engine_glut_488_key_up);
      glutSpecialFunc (engine_glut_488_key_special);
      glutSpecialUpFunc (engine_glut_488_key_special_up);
      glutMouseFunc (engine_glut_488_mouse_button);
      glutMotionFunc (engine_glut_488_mouse_move);
      glutPassiveMotionFunc (engine_glut_488_mouse_move);
      glutTimerFunc (100, engine_glut_488_timer, 0);

      glutCreateMenu (engine_glut_488_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_488.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_488.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_488.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_488.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_488.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_488.frag_3")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader4.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_488.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_488.frag_4")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader5.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_488.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_488.frag_5")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      //glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
      //std::string neg_z_path_string = ACE_TEXT_ALWAYS_CHAR ("");
      //if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_488_texture0.png")))
      //{
      //  ACE_DEBUG ((LM_ERROR,
      //              ACE_TEXT ("failed to load texture, aborting\n")));
      //  break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_488_DEFAULT_WIDTH * ENGINE_GLUT_488_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_488_DEFAULT_WIDTH, ENGINE_GLUT_488_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
      glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_489:
    {
      struct Engine_OpenGL_GLUT_489_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_489_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_489_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_489_DEFAULT_WIDTH, ENGINE_GLUT_489_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 489");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_489_draw);
      glutReshapeFunc (engine_glut_489_reshape);
      glutVisibilityFunc (engine_glut_489_visible);

      glutKeyboardFunc (engine_glut_489_key);
      glutKeyboardUpFunc (engine_glut_489_key_up);
      glutSpecialFunc (engine_glut_489_key_special);
      glutSpecialUpFunc (engine_glut_489_key_special_up);
      glutMouseFunc (engine_glut_489_mouse_button);
      glutMotionFunc (engine_glut_489_mouse_move);
      glutPassiveMotionFunc (engine_glut_489_mouse_move);
      glutTimerFunc (100, engine_glut_489_timer, 0);

      glutCreateMenu (engine_glut_489_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_489.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_489.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_489.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_489.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_489_DEFAULT_WIDTH * ENGINE_GLUT_489_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_489_DEFAULT_WIDTH, ENGINE_GLUT_489_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
      glGenerateMipmap (GL_TEXTURE_2D);
