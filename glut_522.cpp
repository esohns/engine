...
void
engine_glut_522_reshape (int width_in, int height_in)
{
...
void
engine_glut_522_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_522_CBData*> (glutGetWindowData ());
...
void
engine_glut_522_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
...
void
engine_glut_522_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
...
void
engine_glut_522_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
...
void
engine_glut_522_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_522_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_522_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_522_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_522_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_522_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_522_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_522_timer,
                 v);
}

void
engine_glut_522_draw (void)
{
  struct Engine_OpenGL_GLUT_522_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_522_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_522_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_522_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_522_idle);
  else
    glutIdleFunc (NULL);
}
