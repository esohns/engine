...
surface (vec2 uv)
{
  ...
  if (color < 0.1)
    return vec3(0.35, 0.40, 0.44);
  else if (color < 0.2)
    return vec3(0.29, 0.32, 0.35);
  else if (color < 0.3)
    return vec3(0.20, 0.21, 0.22);
  else if (color < 0.55)
    return vec3(0.09, 0.11, 0.09);
  else if (color < 0.65)
    return vec3(0.18, 0.19, 0.14);
  else if (color < 0.75)
    return vec3(0.52, 0.52, 0.33);
  else if (color < 0.85)
    return vec3(0.45, 0.37, 0.27);
  else if (color < 0.95)
    return vec3(0.34, 0.25, 0.17);
  else if (color < 0.99)
    return vec3(0.59, 0.34, 0.29);
  else
