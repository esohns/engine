         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_605:
    {
      struct Engine_OpenGL_GLUT_605_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_605_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_605_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_605_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_605_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_605_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_605_DEFAULT_WIDTH, ENGINE_GLUT_605_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 605");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_605_draw);
      glutReshapeFunc (engine_glut_605_reshape);
      glutVisibilityFunc (engine_glut_605_visible);

      glutKeyboardFunc (engine_glut_605_key);
      glutKeyboardUpFunc (engine_glut_605_key_up);
      glutSpecialFunc (engine_glut_605_key_special);
      glutMouseFunc (engine_glut_605_mouse_button);
      glutMotionFunc (engine_glut_605_mouse_move);
      glutPassiveMotionFunc (engine_glut_605_mouse_move);

      glutTimerFunc (100, engine_glut_605_timer, 0);

      glutCreateMenu (engine_glut_605_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_605.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_605.frag")))
      {
         ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
         break;
    ...
    case ENGINE_MODE_606:
    {
      struct Engine_OpenGL_GLUT_606_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_606_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_606_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_606_DEFAULT_WIDTH, ENGINE_GLUT_606_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 606");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_606_draw);
      glutReshapeFunc (engine_glut_606_reshape);
      glutVisibilityFunc (engine_glut_606_visible);

      glutKeyboardFunc (engine_glut_606_key);
      glutKeyboardUpFunc (engine_glut_606_key_up);
      glutSpecialFunc (engine_glut_606_key_special);
      glutSpecialUpFunc (engine_glut_606_key_special_up);

      glutMouseFunc (engine_glut_606_mouse_button);
      glutMotionFunc (engine_glut_606_mouse_move);
      glutPassiveMotionFunc (engine_glut_606_mouse_move);

      glutTimerFunc (100, engine_glut_606_timer, 0);

      glutCreateMenu (engine_glut_606_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_606.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_606.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_606.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_606.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_606_channel1.png")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_606_DEFAULT_WIDTH * ENGINE_GLUT_606_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_606_DEFAULT_WIDTH, ENGINE_GLUT_606_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
      //glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_607:
    {
      struct Engine_OpenGL_GLUT_607_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_607_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_607_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_607_DEFAULT_WIDTH, ENGINE_GLUT_607_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 607");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_607_draw);
      glutReshapeFunc (engine_glut_607_reshape);
      glutVisibilityFunc (engine_glut_607_visible);

      glutKeyboardFunc (engine_glut_607_key);
      glutKeyboardUpFunc (engine_glut_607_key_up);
      glutSpecialFunc (engine_glut_607_key_special);
      glutSpecialUpFunc (engine_glut_607_key_special_up);

      glutMouseFunc (engine_glut_607_mouse_button);
      glutMotionFunc (engine_glut_607_mouse_move);
      glutPassiveMotionFunc (engine_glut_607_mouse_move);

      glutTimerFunc (100, engine_glut_607_timer, 0);

      glutCreateMenu (engine_glut_607_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_607.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_607.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_607.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_607.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_607_DEFAULT_WIDTH * ENGINE_GLUT_607_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_607_DEFAULT_WIDTH, ENGINE_GLUT_607_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
      //glGenerateMipmap (GL_TEXTURE_2D);
    ...
    case ENGINE_MODE_608:
    {
      struct Engine_OpenGL_GLUT_608_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_608_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_608_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_608_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_608_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_608_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_608_DEFAULT_WIDTH, ENGINE_GLUT_608_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 608");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_608_draw);
      glutReshapeFunc (engine_glut_608_reshape);
      glutVisibilityFunc (engine_glut_608_visible);

      glutKeyboardFunc (engine_glut_608_key);
      glutKeyboardUpFunc (engine_glut_608_key_up);
      glutSpecialFunc (engine_glut_608_key_special);
      glutMouseFunc (engine_glut_608_mouse_button);
      glutMotionFunc (engine_glut_608_mouse_move);
      glutPassiveMotionFunc (engine_glut_608_mouse_move);

      glutTimerFunc (100, engine_glut_608_timer, 0);

      glutCreateMenu (engine_glut_608_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_608.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_608.frag")))
      {
         ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
         break;
    ...
    case ENGINE_MODE_609:
    {
      struct Engine_OpenGL_GLUT_609_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_609_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_609_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_609_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_609_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_609_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_609_DEFAULT_WIDTH, ENGINE_GLUT_609_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 609");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_609_draw);
      glutReshapeFunc (engine_glut_609_reshape);
      glutVisibilityFunc (engine_glut_609_visible);

      glutKeyboardFunc (engine_glut_609_key);
      glutKeyboardUpFunc (engine_glut_609_key_up);
      glutSpecialFunc (engine_glut_609_key_special);
      glutMouseFunc (engine_glut_609_mouse_button);
      glutMotionFunc (engine_glut_609_mouse_move);
      glutPassiveMotionFunc (engine_glut_609_mouse_move);

      glutTimerFunc (100, engine_glut_609_timer, 0);

      glutCreateMenu (engine_glut_609_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_609.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_609.frag")))
      {
         ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
         break;
