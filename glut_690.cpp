...
void
engine_glut_690_reshape (int width_in, int height_in)
{
...
void
engine_glut_690_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_690_CBData*> (glutGetWindowData ());
...
void
engine_glut_690_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
...
void
engine_glut_690_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
...
void
engine_glut_690_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
...
void
engine_glut_690_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_690_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_690_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_690_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_690_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_690_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_690_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_690_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_690_timer,
                 v);
}

void
engine_glut_690_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_690_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_690_DEFAULT_HEIGHT));
  ...
  glProgramUniform1f (cb_data_p->shader3.id_, cb_data_p->S3timeDeltaLoc,
                      static_cast<GLfloat> (d_2.count () * 0.001f));
...
void
engine_glut_690_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_690_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_690_idle);
  else
    glutIdleFunc (NULL);
}
