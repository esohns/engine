...
//      ACE_ASSERT (cb_data_s.S5timeLoc != -1);
    ...
    case ENGINE_MODE_947:
    {
      struct Engine_OpenGL_GLUT_947_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_947_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_947_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_947_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_947_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_947_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_947_DEFAULT_WIDTH, ENGINE_GLUT_947_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 947");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_947_draw);
      glutReshapeFunc (engine_glut_947_reshape);
      glutVisibilityFunc (engine_glut_947_visible);

      glutKeyboardFunc (engine_glut_947_key);
      glutKeyboardUpFunc (engine_glut_947_key_up);
      glutSpecialFunc (engine_glut_947_key_special);
      glutMouseFunc (engine_glut_947_mouse_button);
      glutMotionFunc (engine_glut_947_mouse_move);
      glutPassiveMotionFunc (engine_glut_947_mouse_move);

      glutTimerFunc (100, engine_glut_947_timer, 0);

      glutCreateMenu (engine_glut_947_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_947.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_947.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_948:
    {
      struct Engine_OpenGL_GLUT_948_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_948_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_948_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_948_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_948_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_948_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_948_DEFAULT_WIDTH, ENGINE_GLUT_948_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 948");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_948_draw);
      glutReshapeFunc (engine_glut_948_reshape);
      glutVisibilityFunc (engine_glut_948_visible);

      glutKeyboardFunc (engine_glut_948_key);
      glutKeyboardUpFunc (engine_glut_948_key_up);
      glutSpecialFunc (engine_glut_948_key_special);
      glutMouseFunc (engine_glut_948_mouse_button);
      glutMotionFunc (engine_glut_948_mouse_move);
      glutPassiveMotionFunc (engine_glut_948_mouse_move);

      glutTimerFunc (100, engine_glut_948_timer, 0);

      glutCreateMenu (engine_glut_948_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      if (!cb_data_s.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_948.vert"),
                                          ACE_TEXT_ALWAYS_CHAR ("glut_948.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
    ...
    case ENGINE_MODE_949:
    {
      struct Engine_OpenGL_GLUT_949_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_949_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_949_DEFAULT_HEIGHT / 2;
      cb_data_s.mouseLMBPressed = false;
      ...
      glutSetOption (GLUT_ACTION_ON_WINDOW_CLOSE, GLUT_ACTION_GLUTMAINLOOP_RETURNS);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_949_DEFAULT_WIDTH, ENGINE_GLUT_949_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 949");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_949_draw);
      glutReshapeFunc (engine_glut_949_reshape);
      glutVisibilityFunc (engine_glut_949_visible);

      glutKeyboardFunc (engine_glut_949_key);
      glutKeyboardUpFunc (engine_glut_949_key_up);
      glutSpecialFunc (engine_glut_949_key_special);
      glutSpecialUpFunc (engine_glut_949_key_special_up);

      glutMouseFunc (engine_glut_949_mouse_button);
      glutMotionFunc (engine_glut_949_mouse_move);
      glutPassiveMotionFunc (engine_glut_949_mouse_move);

      glutTimerFunc (100, engine_glut_949_timer, 0);

      glutCreateMenu (engine_glut_949_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);

      if (!cb_data_s.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_949.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_949.frag")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      } // end IF
      if (!cb_data_s.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR ("glut_949.vert"),
                                           ACE_TEXT_ALWAYS_CHAR ("glut_949.frag_2")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load shader, aborting\n")));
        break;
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!cb_data_s.texture0.load (ACE_TEXT_ALWAYS_CHAR ("glut_949_channel1.png")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      ...
      ACE_ASSERT (cb_data_s.textureS1.id_);
      cb_data_s.textureS1.bind ();
      std::vector<GLfloat> initial_values_a (ENGINE_GLUT_949_DEFAULT_WIDTH * ENGINE_GLUT_949_DEFAULT_HEIGHT * 4, 0.0f);
      // *IMPORTANT NOTE*: generate a floating point-format texture to contain
      //                   the result of shader1
      glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA32F, ENGINE_GLUT_949_DEFAULT_WIDTH, ENGINE_GLUT_949_DEFAULT_HEIGHT, 0, GL_RGBA, GL_FLOAT, initial_values_a.data ());
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
      glGenerateMipmap (GL_TEXTURE_2D);
