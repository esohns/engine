...
void
engine_glut_239_reshape (int width_in, int height_in)
{
...
void
engine_glut_239_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_239_CBData*> (glutGetWindowData ());
...
void
engine_glut_239_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
...
void
engine_glut_239_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_239_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_239_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_239_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_239_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_239_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  glProgramUniform2f (cb_data_p->programId, cb_data_p->mouseLoc,
                      ...
                      static_cast<float> (Common_GL_Tools::map (y, 0, ENGINE_GLUT_239_DEFAULT_HEIGHT, ENGINE_GLUT_239_DEFAULT_HEIGHT, 0) / 1000.0f));
}

void
engine_glut_239_timer (int v)
{
  struct Engine_OpenGL_GLUT_239_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_239_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  glutTimerFunc (1000 / 30,
                 engine_glut_239_timer,
                 v);
}

void
engine_glut_239_draw (void)
{
  ...
  glProgramUniform2f (cb_data_p->programId, cb_data_p->resolutionLoc,
                      static_cast<float> (ENGINE_GLUT_239_DEFAULT_WIDTH),
                      static_cast<float> (ENGINE_GLUT_239_DEFAULT_HEIGHT));
  glProgramUniform1f (cb_data_p->programId, cb_data_p->timeLoc,
                      frame_count_i * 0.01f);

  glTranslatef (-static_cast<GLfloat> (ENGINE_GLUT_239_DEFAULT_WIDTH / 2.0f),
                -static_cast<GLfloat> (ENGINE_GLUT_239_DEFAULT_HEIGHT / 2.0f),
                0.0f);
...
void
engine_glut_239_idle (void)
{
  glutPostRedisplay ();
}

void
engine_glut_239_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_239_idle);
  else
    glutIdleFunc (NULL);
}
