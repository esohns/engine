         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    {
      PGE_62 example;
      if (example.Construct (ENGINE_PGE_62_DEFAULT_WIDTH, ENGINE_PGE_62_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_63 example;
      if (example.Construct (ENGINE_PGE_63_DEFAULT_WIDTH, ENGINE_PGE_63_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_64 example;
      if (example.Construct (ENGINE_PGE_64_DEFAULT_WIDTH, ENGINE_PGE_64_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_65 example;
      if (example.Construct (ENGINE_PGE_65_DEFAULT_WIDTH, ENGINE_PGE_65_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_66 example;
      if (example.Construct (ENGINE_PGE_66_DEFAULT_WIDTH, ENGINE_PGE_66_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_67 example;
      if (example.Construct (ENGINE_PGE_67_DEFAULT_WIDTH, ENGINE_PGE_67_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_68 example;
      if (example.Construct (ENGINE_PGE_68_DEFAULT_WIDTH, ENGINE_PGE_68_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_71 example;
      if (example.Construct (ENGINE_PGE_71_DEFAULT_WIDTH, ENGINE_PGE_71_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_72 example;
      if (example.Construct (ENGINE_PGE_72_DEFAULT_WIDTH, ENGINE_PGE_72_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_73 example;
      if (example.Construct (ENGINE_PGE_73_DEFAULT_WIDTH, ENGINE_PGE_73_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_74 example;
      if (example.Construct (ENGINE_PGE_74_DEFAULT_WIDTH, ENGINE_PGE_74_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_75 example;
      if (example.Construct (ENGINE_PGE_75_DEFAULT_WIDTH, ENGINE_PGE_75_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_76 example;
      if (example.Construct (ENGINE_PGE_76_DEFAULT_WIDTH, ENGINE_PGE_76_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_77 example;
      if (example.Construct (ENGINE_PGE_77_DEFAULT_WIDTH, ENGINE_PGE_77_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_78 example;
      if (example.Construct (ENGINE_PGE_78_DEFAULT_WIDTH, ENGINE_PGE_78_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_79 example;
      if (example.Construct (ENGINE_PGE_79_DEFAULT_WIDTH, ENGINE_PGE_79_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_80 example;
      if (example.Construct (ENGINE_PGE_80_DEFAULT_WIDTH, ENGINE_PGE_80_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
    ...
    {
      PGE_89 example;
      if (example.Construct (ENGINE_PGE_89_DEFAULT_WIDTH, ENGINE_PGE_89_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
