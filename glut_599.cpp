...
void
engine_glut_599_reshape (int width_in, int height_in)
{
...
void
engine_glut_599_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_599_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    ...
    case 100: /* d */
      ...
      break;
    case 102: /* f */
      cb_data_p->isFKeyPressed = true;
      break;
  } // end SWITCH
}

void
engine_glut_599_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
  ...
  switch (key_in)
  {
    ...
    case 100: /* d */
      ...
      break;
    case 102: /* f */
      cb_data_p->isFKeyPressed = false;
      break;
  } // end SWITCH
}

void
engine_glut_599_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
...
void
engine_glut_599_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
...
void
engine_glut_599_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_599_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_599_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_599_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_599_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_599_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_599_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_599_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_599_timer,
                 v);
}

void
engine_glut_599_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_599_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_599_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader1.id_, cb_data_p->S1mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_599_DEFAULT_HEIGHT - 1, ENGINE_GLUT_599_DEFAULT_HEIGHT - 1, 0)),
                      static_cast<GLfloat> (cb_data_p->mouseLMBPressed ? 1 : 0),
                      0.0f);

  glProgramUniform4f (cb_data_p->shader1.id_, cb_data_p->S1keysLoc,
                      static_cast<GLfloat> (cb_data_p->isAKeyPressed ? 1 : 0),
                      static_cast<GLfloat> (cb_data_p->isSKeyPressed ? 1 : 0),
                      static_cast<GLfloat> (cb_data_p->isDKeyPressed ? 1 : 0),
                      static_cast<GLfloat> (cb_data_p->isFKeyPressed ? 1 : 0));
...
void
engine_glut_599_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_599_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_599_idle);
  else
    glutIdleFunc (NULL);
}
