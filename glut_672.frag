...
vec3
alphaBlend (vec3 back, vec4 front)
{
...
vec3
skyColor (vec3 ro, vec3 rd)
{
  return vec3(0.0);
}

float
mod1 (inout float p, float size)
{
...
vec4
plane (vec3 ro, vec3 rd, vec3 pp, vec3 off, float aa, float n)
{
