...
void
engine_glut_544_reshape (int width_in, int height_in)
{
...
void
engine_glut_544_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_544_CBData*> (glutGetWindowData ());
...
void
engine_glut_544_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
...
void
engine_glut_544_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
...
void
engine_glut_544_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
...
void
engine_glut_544_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_544_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_544_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_544_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_544_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_544_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_544_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_544_timer,
                 v);
}

void
engine_glut_544_draw (void)
{
  struct Engine_OpenGL_GLUT_544_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_544_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_544_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_544_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_544_idle);
  else
    glutIdleFunc (NULL);
}
