...
randomizeParameters (struct Engine_OpenGL_GLUT_425_CBData& CBData_inout)
{
  ...
  static Common_GL_Color_t palettes_a[ENGINE_GLUT_425_DEFAULT_NUMBER_OF_PALETTES][5] = {
    {Common_GL_Color_t (0xed, 0x22, 0x5d), Common_GL_Color_t (0x3c, 0xaf, 0x65), Common_GL_Color_t (0x0d, 0x40, 0xbf), Common_GL_Color_t (0xf5, 0xb8, 0x00), Common_GL_Color_t (0x2a, 0x2a, 0x2a)},
    {Common_GL_Color_t (0xb3, 0x00, 0x00), Common_GL_Color_t (0xe6, 0xcf, 0x00), Common_GL_Color_t (0x12, 0x83, 0xb3), Common_GL_Color_t (0xfa, 0xfa, 0xfa), Common_GL_Color_t (0x0a, 0x0a, 0x0a)},
    {Common_GL_Color_t (0x60, 0x6c, 0x38), Common_GL_Color_t (0x28, 0x36, 0x18), Common_GL_Color_t (0xfe, 0xfa, 0xe0), Common_GL_Color_t (0xdd, 0xa1, 0x5e), Common_GL_Color_t (0xbc, 0x6c, 0x25)},
    {Common_GL_Color_t (0x00, 0x14, 0x27), Common_GL_Color_t (0x70, 0x8d, 0x81), Common_GL_Color_t (0xf4, 0xd5, 0x8d), Common_GL_Color_t (0xbf, 0x06, 0x03), Common_GL_Color_t (0x8d, 0x08, 0x01)},
    {Common_GL_Color_t (0x3d, 0x5a, 0x80), Common_GL_Color_t (0x98, 0xc1, 0xd9), Common_GL_Color_t (0xe0, 0xfb, 0xfc), Common_GL_Color_t (0xee, 0x6c, 0x4d), Common_GL_Color_t (0x29, 0x32, 0x41)},
    {Common_GL_Color_t (0x44, 0x64, 0xa1), Common_GL_Color_t (0x62, 0xb6, 0xde), Common_GL_Color_t (0xb3, 0xdc, 0xe0), Common_GL_Color_t (0xfa, 0xfa, 0xfa), Common_GL_Color_t (0xff, 0xc5, 0xc7)},
    {Common_GL_Color_t (0x35, 0x35, 0x35), Common_GL_Color_t (0x3c, 0x6e, 0x71), Common_GL_Color_t (0xff, 0xff, 0xff), Common_GL_Color_t (0xd9, 0xd9, 0xd9), Common_GL_Color_t (0x28, 0x4b, 0x63)},
    {Common_GL_Color_t (0x00, 0x81, 0xa7), Common_GL_Color_t (0x00, 0xaf, 0xb9), Common_GL_Color_t (0xfd, 0xfc, 0xdc), Common_GL_Color_t (0xfe, 0xd9, 0xb7), Common_GL_Color_t (0xf0, 0x71, 0x67)},
    {Common_GL_Color_t (0x00, 0x4b, 0x23), Common_GL_Color_t (0x00, 0x64, 0x00), Common_GL_Color_t (0x00, 0x72, 0x00), Common_GL_Color_t (0x00, 0x80, 0x00), Common_GL_Color_t (0x38, 0xb0, 0x00)},
    {Common_GL_Color_t (0x0a, 0x11, 0x28), Common_GL_Color_t (0x00, 0x1f, 0x54), Common_GL_Color_t (0x03, 0x40, 0x78), Common_GL_Color_t (0x12, 0x82, 0xa2), Common_GL_Color_t (0xfe, 0xfc, 0xfb)},
    {Common_GL_Color_t (0x2d, 0x31, 0x42), Common_GL_Color_t (0xbf, 0xc0, 0xc0), Common_GL_Color_t (0xff, 0xff, 0xff), Common_GL_Color_t (0xef, 0x83, 0x54), Common_GL_Color_t (0x4f, 0x5d, 0x75)},
    {Common_GL_Color_t (0x04, 0x15, 0x1f), Common_GL_Color_t (0x18, 0x3a, 0x37), Common_GL_Color_t (0xef, 0xd6, 0xac), Common_GL_Color_t (0xc4, 0x49, 0x00), Common_GL_Color_t (0x43, 0x25, 0x34)},
    {Common_GL_Color_t (0xca, 0x9c, 0xe1), Common_GL_Color_t (0x54, 0xde, 0xfd), Common_GL_Color_t (0xf1, 0xff, 0xc4), Common_GL_Color_t (0xff, 0xca, 0xaf), Common_GL_Color_t (0x28, 0x58, 0x7b)}
  };
