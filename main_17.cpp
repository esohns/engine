         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_386:
    {
      struct Engine_OpenGL_GLUT_386_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_386_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_386_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_386_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_386_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_386_DEFAULT_HEIGHT / 2;

      // initialize GLUT
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_386_DEFAULT_WIDTH, ENGINE_GLUT_386_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 386");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_386_draw);
      glutReshapeFunc (engine_glut_386_reshape);
      glutVisibilityFunc (engine_glut_386_visible);

      glutKeyboardFunc (engine_glut_386_key);
      glutSpecialFunc (engine_glut_386_key_special);
      glutMouseFunc (engine_glut_386_mouse_button);
      glutMotionFunc (engine_glut_386_mouse_move);
      glutPassiveMotionFunc (engine_glut_386_mouse_move);
      glutTimerFunc (100, engine_glut_386_timer, 0);

      glutCreateMenu (engine_glut_386_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      uint8_t* data_p = NULL;
      ACE_UINT64 file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_386.vert"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
      ...
      data_p = NULL;
      file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_386.frag"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
    ...
    case ENGINE_MODE_388:
    {
      struct Engine_OpenGL_GLUT_388_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_388_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_388_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_388_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_388_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_388_DEFAULT_HEIGHT / 2;

      // initialize GLUT
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_388_DEFAULT_WIDTH, ENGINE_GLUT_388_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 388");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_388_draw);
      glutReshapeFunc (engine_glut_388_reshape);
      glutVisibilityFunc (engine_glut_388_visible);

      glutKeyboardFunc (engine_glut_388_key);
      glutSpecialFunc (engine_glut_388_key_special);
      glutMouseFunc (engine_glut_388_mouse_button);
      glutMotionFunc (engine_glut_388_mouse_move);
      glutPassiveMotionFunc (engine_glut_388_mouse_move);
      glutTimerFunc (100, engine_glut_388_timer, 0);

      glutCreateMenu (engine_glut_388_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      uint8_t* data_p = NULL;
      ACE_UINT64 file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_388.vert"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
      ...
      data_p = NULL;
      file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_388.frag"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
    ...
    case ENGINE_MODE_389:
    {
      struct Engine_OpenGL_GLUT_389_CBData cb_data_s;

      cb_data_s.scaleFactor = ENGINE_GLUT_389_DEFAULT_SCALE_FACTOR;
      cb_data_s.columns = ENGINE_GLUT_389_DEFAULT_WIDTH / cb_data_s.scaleFactor;
      cb_data_s.rows = ENGINE_GLUT_389_DEFAULT_HEIGHT / cb_data_s.scaleFactor;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_389_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_389_DEFAULT_HEIGHT / 2;

      // initialize GLUT
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_389_DEFAULT_WIDTH, ENGINE_GLUT_389_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 389");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_389_draw);
      glutReshapeFunc (engine_glut_389_reshape);
      glutVisibilityFunc (engine_glut_389_visible);

      glutKeyboardFunc (engine_glut_389_key);
      glutSpecialFunc (engine_glut_389_key_special);
      glutMouseFunc (engine_glut_389_mouse_button);
      glutMotionFunc (engine_glut_389_mouse_move);
      glutPassiveMotionFunc (engine_glut_389_mouse_move);
      glutTimerFunc (100, engine_glut_389_timer, 0);

      glutCreateMenu (engine_glut_389_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
      ...
      uint8_t* data_p = NULL;
      ACE_UINT64 file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_389.vert"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
      ...
      data_p = NULL;
      file_size_i = 0;
      if (!Common_File_Tools::load (ACE_TEXT_ALWAYS_CHAR ("glut_389.frag"),
                                    data_p,
                                    file_size_i,
                                    0))
      {
      ...
      for (int i = 0; i < ENGINE_GLUT_389_DEFAULT_NUMBER_OF_WHIRLS; i++)
      {
        ...
        whirl_s.p = p;
        whirl_s.r = Common_Tools::getRandomNumber (0.1f, 0.5f);
        whirl_s.distortForce =
          Common_Tools::getRandomNumber (0.0f, 1.0f) * Common_Tools::getRandomNumber (0.0f, 0.15f);
