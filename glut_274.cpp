...
void
engine_glut_274_reshape (int width_in, int height_in)
{
...
void
engine_glut_274_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_274_CBData*> (glutGetWindowData ());
...
void
engine_glut_274_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
...
void
engine_glut_274_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_274_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_274_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_274_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_274_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_274_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  float xMouse =
    (x / static_cast<float> (ENGINE_GLUT_274_DEFAULT_WIDTH)) * 2.0f - 1.0f;
  xMouse =
    (xMouse * ENGINE_GLUT_274_DEFAULT_WIDTH) / static_cast<float> (ENGINE_GLUT_274_DEFAULT_HEIGHT);
  float yMouse =
    (Common_GL_Tools::map (y, 0, ENGINE_GLUT_274_DEFAULT_HEIGHT, ENGINE_GLUT_274_DEFAULT_HEIGHT, 0) / static_cast<float> (ENGINE_GLUT_274_DEFAULT_HEIGHT)) * 2.0f - 1.0f;
...
engine_glut_274_timer (int v)
{
  ...
  glutTimerFunc (1000 / 30,
                 engine_glut_274_timer,
                 v);
}

void
engine_glut_274_draw (void)
{
  struct Engine_OpenGL_GLUT_274_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_274_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  glProgramUniform2f (cb_data_p->programId, cb_data_p->resolutionLoc,
                      static_cast<float> (ENGINE_GLUT_274_DEFAULT_WIDTH),
                      static_cast<float> (ENGINE_GLUT_274_DEFAULT_HEIGHT));
...
#error missing implementation, aborting
  ...
  glTranslatef (static_cast<GLfloat> (-ENGINE_GLUT_274_DEFAULT_WIDTH / 2.0f),
                static_cast<GLfloat> (-ENGINE_GLUT_274_DEFAULT_HEIGHT / 2.0f),
                0.0f);
...
void
engine_glut_274_idle (void)
{
  glutPostRedisplay ();
}

void
engine_glut_274_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_274_idle);
  else
    glutIdleFunc (NULL);
}
