         ...
         enum Engine_ModeType mode_in)
{
  ...
  switch (mode_in)
  {
    ...
    case ENGINE_MODE_315:
    {
      struct Engine_OpenGL_GLUT_315_CBData cb_data_s;
      ...
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_315_DEFAULT_WIDTH, ENGINE_GLUT_315_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 315");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_315_draw);
      glutReshapeFunc (engine_glut_315_reshape);
      glutVisibilityFunc (engine_glut_315_visible);

      glutKeyboardFunc (engine_glut_315_key);
      glutSpecialFunc (engine_glut_315_key_special);
      glutMouseFunc (engine_glut_315_mouse_button);
      glutMotionFunc (engine_glut_315_mouse_move);
      glutPassiveMotionFunc (engine_glut_315_mouse_move);
      glutTimerFunc (100, engine_glut_315_timer, 0);

      glutCreateMenu (engine_glut_315_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
    ...
    case ENGINE_MODE_316:
    {
      struct Engine_OpenGL_GLUT_316_CBData cb_data_s;
      ...
      cb_data_s.mouseX = ENGINE_GLUT_316_DEFAULT_WIDTH / 2;
      cb_data_s.mouseY = ENGINE_GLUT_316_DEFAULT_HEIGHT / 2;

      // initialize GLUT
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_316_DEFAULT_WIDTH, ENGINE_GLUT_316_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 316");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_316_draw);
      glutReshapeFunc (engine_glut_316_reshape);
      glutVisibilityFunc (engine_glut_316_visible);

      glutKeyboardFunc (engine_glut_316_key);
      glutSpecialFunc (engine_glut_316_key_special);
      glutMouseFunc (engine_glut_316_mouse_button);
      glutMotionFunc (engine_glut_316_mouse_move);
      glutPassiveMotionFunc (engine_glut_316_mouse_move);
      glutTimerFunc (100, engine_glut_316_timer, 0);

      glutCreateMenu (engine_glut_316_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
    ...
    case ENGINE_MODE_317:
    {
      struct Engine_OpenGL_GLUT_317_CBData cb_data_s;
      cb_data_s.w =
        std::min (ENGINE_GLUT_317_DEFAULT_WIDTH, ENGINE_GLUT_317_DEFAULT_HEIGHT);
      cb_data_s.r = cb_data_s.w / 4.0f;
      cb_data_s.zStart = static_cast<float> (cb_data_s.w);
      cb_data_s.loopTime = 6 * 60;
      ...
      //cb_data_s.mouseX = ENGINE_GLUT_317_DEFAULT_WIDTH / 2;
      //cb_data_s.mouseY = ENGINE_GLUT_317_DEFAULT_HEIGHT / 2;

      // initialize GLUT
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_317_DEFAULT_WIDTH, ENGINE_GLUT_317_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 317");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_317_draw);
      glutReshapeFunc (engine_glut_317_reshape);
      glutVisibilityFunc (engine_glut_317_visible);

      glutKeyboardFunc (engine_glut_317_key);
      glutSpecialFunc (engine_glut_317_key_special);
      glutMouseFunc (engine_glut_317_mouse_button);
      glutMotionFunc (engine_glut_317_mouse_move);
      glutPassiveMotionFunc (engine_glut_317_mouse_move);
      glutTimerFunc (100, engine_glut_317_timer, 0);

      glutCreateMenu (engine_glut_317_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
    ...
    case ENGINE_MODE_318:
    {
      struct Engine_OpenGL_GLUT_318_CBData cb_data_s;
      cb_data_s.f = 0;
      ...
      glutInit (&argc_in, argv_in);
      glutInitDisplayMode (GLUT_RGBA | GLUT_DOUBLE | GLUT_ALPHA | GLUT_DEPTH);
      glutInitWindowSize (ENGINE_GLUT_318_DEFAULT_WIDTH, ENGINE_GLUT_318_DEFAULT_HEIGHT);

      int window_i = glutCreateWindow ("engine GLUT 318");
      glutSetWindow (window_i);
      glutSetWindowData (&cb_data_s);
      ...
      glutDisplayFunc (engine_glut_318_draw);
      glutReshapeFunc (engine_glut_318_reshape);
      glutVisibilityFunc (engine_glut_318_visible);

      glutKeyboardFunc (engine_glut_318_key);
      glutSpecialFunc (engine_glut_318_key_special);
      glutMouseFunc (engine_glut_318_mouse_button);
      glutMotionFunc (engine_glut_318_mouse_move);
      glutPassiveMotionFunc (engine_glut_318_mouse_move);
      glutTimerFunc (100, engine_glut_318_timer, 0);

      glutCreateMenu (engine_glut_318_menu);
      glutAddMenuEntry (ACE_TEXT_ALWAYS_CHAR ("wireframe"), 0);
      glutAttachMenu (GLUT_RIGHT_BUTTON);
    ...
    case ENGINE_MODE_319:
    {
      PGE_319 example;
      if (example.Construct (ENGINE_PGE_319_DEFAULT_WIDTH, ENGINE_PGE_319_DEFAULT_HEIGHT,
                             1, 1,
                             false,  // fullscreen ?
                             false,  // vsync ?
                             false)) // cohesion ?
