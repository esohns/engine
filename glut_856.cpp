...
void
engine_glut_856_reshape (int width_in,
                         int height_in)
{
...
void
engine_glut_856_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_856_CBData*> (glutGetWindowData ());
...
void
engine_glut_856_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
...
void
engine_glut_856_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
...
void
engine_glut_856_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
...
void
engine_glut_856_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_856_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_856_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_856_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_856_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_856_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_856_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_856_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_856_timer,
                 v);
}

void
engine_glut_856_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader.id_, cb_data_p->resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_856_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_856_DEFAULT_HEIGHT));
...
void
engine_glut_856_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_856_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_856_idle);
  else
    glutIdleFunc (NULL);
}
