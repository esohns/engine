...
void
engine_glut_683_reshape (int width_in, int height_in)
{
...
void
engine_glut_683_key (unsigned char key_in,
                     int x,
                     int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_683_CBData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
      ...
      break;
    case 99: /* c */
      cb_data_p->isCKeyPressed = true;
      break;
    case 105: /* i */
      cb_data_p->isIKeyPressed = true;
      break;
    case 115: /* s */
...
void
engine_glut_683_key_up (unsigned char key_in,
                        int x,
                        int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
  ...
  {
    case 99: /* c */
      cb_data_p->isCKeyPressed = false;
      break;
    case 105: /* i */
      cb_data_p->isIKeyPressed = false;
      break;
    case 115: /* s */
...
void
engine_glut_683_key_special (int key_in,
                             int x,
                             int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
...
void
engine_glut_683_key_special_up (int key_in,
                                int x,
                                int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
...
void
engine_glut_683_menu (int entry_in)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_683_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_683_mouse_button (int button, int state, int x, int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_683_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
engine_glut_683_mouse_move (int x, int y)
{
  struct Engine_OpenGL_GLUT_683_CBData* cb_data_p =
    static_cast<struct Engine_OpenGL_GLUT_683_CBData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
engine_glut_683_timer (int v)
{
  ...
  glutTimerFunc (1000 / 60,
                 engine_glut_683_timer,
                 v);
}

void
engine_glut_683_draw (void)
{
...
#error missing implementation, aborting
  ...
  glProgramUniform2f (cb_data_p->shader1.id_, cb_data_p->S1resolutionLoc,
                      static_cast<GLfloat> (ENGINE_GLUT_683_DEFAULT_WIDTH),
                      static_cast<GLfloat> (ENGINE_GLUT_683_DEFAULT_HEIGHT));
  ...
  glProgramUniform4f (cb_data_p->shader2.id_, cb_data_p->S2mouseLoc,
                      ...
                      static_cast<GLfloat> (Common_GL_Tools::map (cb_data_p->mouseY, 0, ENGINE_GLUT_683_DEFAULT_HEIGHT - 1, ENGINE_GLUT_683_DEFAULT_HEIGHT - 1, 0)),
  ...
  glProgramUniform4i (cb_data_p->shader2.id_, cb_data_p->S2keysLoc,
                      ...
                      static_cast<GLint> (cb_data_p->isIKeyPressed ? 1 : 0),
...
void
engine_glut_683_idle (void)
{
  //glutPostRedisplay ();
}

void
engine_glut_683_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (engine_glut_683_idle);
  else
    glutIdleFunc (NULL);
}
