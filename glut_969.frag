...
vec3
GetParticleColour (vec3 vParticlePos, float fParticleSize, vec3 vRayDir)
{
...
vec3
GetParticlePos (vec3 vRayDir, float fZPos, float fSeed)
{
...
vec3
Starfield (vec3 vRayDir, float fZPos, float fSeed)
{	
...
main ()
{
  vec2 vScreenUV = gl_FragCoord.xy / iResolution;
